...
const Header = () => {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-background border-b-5 border-[#441a1a]75 dark:border-[#977676]/50 shadow-sm transition-colors duration-200">
      {/* Main Navigation Bar */}
