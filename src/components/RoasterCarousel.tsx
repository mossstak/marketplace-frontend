    ...
    <div>
      ...
      <div className="mt-6 flex items-center justify-between">
        <button
          ...
          disabled={page === 0}
          className="rounded-lg border border-black/20 dark:border-white/20 bg-white/40 dark:bg-zinc-900/40 px-3.5 py-2 text-sm font-medium disabled:opacity-40 cursor-pointer disabled:cursor-not-allowed hover:bg-white/80 dark:hover:bg-zinc-800 transition active:scale-95"
        >
          &larr; Prev
        </button>
