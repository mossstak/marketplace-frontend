        ...
        <div className="bg-gray-800/80 border border-gray-700/80 p-6 sm:p-8 rounded-2xl shadow-lg space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-gray-700">
            <h2 className="text-xl font-bold text-white flex items-center gap-2">
              <Package className="h-5 w-5 text-amber-400" /> My Orders ({orders.length})
            </h2>
            <Link
              href="/shop"
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-300 text-sm mb-4">You haven't placed any orders yet.</p>
              <Link
                href="/shop"
                  ...
                  <div className="space-y-1.5 pt-1">
                    ...
                    <div className="grid gap-2 sm:grid-cols-2">
                      {(order.items ?? []).map((item) => (
                        <div
                          key={item.id}
                          className="flex justify-between items-center text-xs bg-gray-800/60 px-3 py-2 rounded-lg border border-gray-700/40"
                        >
                          <span className="text-gray-300">
                            Variant #{item.productVariantId} &times; {item.quantity}
                          </span>
